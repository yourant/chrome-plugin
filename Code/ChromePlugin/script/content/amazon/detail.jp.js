...
const detailFn = {
  ...
  async clickIcon() {
    ...
    if (lang && lang !== 'en_US') {
      ...
      common.setCookie('lc-main', 'en_US', 365, '.amazon.co.jp')
      location.reload()
      return
    } else {
  ...
  //   };
  //   const tree_name = [];
  //   if ($(".a-unordered-list.a-horizontal.a-size-small a").length) {
  ...
  //     }
  //   /** ====================================补充size尺寸没有打开下拉================================== **/
  //   // if ($('span.a-button-text.a-declarative').is(':visible')) {
  //   //     if ($('#native_dropdown_selected_size_name option').length) {
  //   //         $('span.a-button-text.a-declarative').click();
  //   //         const sizeList2 = $('#native_dropdown_selected_size_name option')
  //   //         arr.push(...await this.getSectionSpecifics(baseData, sizeList2, 'size2'))
  //   //     } else {
  ...
  //       const variationSizeList = $('#variation_size_name select option').length ?
  ...
  //     if ($('#variation_style_name ul li').length) {
  ...
  //     if ($('#variation_color_name ul li').length) {
  //       $('#variation_color_name ul').click()
  ...
  //       if (index === 0 && $(element).eq(index).find('a').text().trim() === 'Select' || (index === 0 && $(element).eq(index).text().trim() === '選択')) {
  //         index++
  //         continue
  //       }
  //       /* 如果下拉框隐藏  则点击 */
  ...
  //           $('#variation_size_name select').click()
  //         } else if (type === 'style') {
  //           $(element).eq(index).find('button.a-button-text')[0].click()
  ...
  //       if ($(liList).eq(index).text().indexOf('開始日') > -1) {
  ...
  //       value: $(paramsList).eq(index).text().split(':').slice(1).join(':') //多个冒号
  //     })
  //     index++
  //   }
  //   else {  //不带a标签的
  ...
  //       arr.push({
  //         key: this.formatText($(paramsList).eq(index).find('b').text().trim()),
  //         value: this.formatText($(paramsList).eq(index).text().split(':')[1])
  //       })
  ...
  //       arr.push({
  //         key: this.formatText($(productDetails).eq(index).find('td.label').text().trim()),
  //         value: this.formatText($(productDetails).eq(index).find('td.value').text()).trim()
  //       })
  ...
  //       //   value = this.formatText($(deUlLi).eq(index).text().split(':')[1])
  //       // }else{
  //       //   value = this.formatText($(deUlLi).eq(index).text().split('：')[1])
  //       // }
  //       // arr.push({
  //       //   key: this.formatText($(deUlLi).eq(index).find('b').text().trim()),
  //       //   value:value
  //       // })
  ...
  //       // arr.push({
  //       //   key: this.formatText($(ProliList).eq(index).find('b').text().trim()),
  //       //   value: this.formatText($(ProliList).eq(index).text().split(':')[1])
  //       // })
