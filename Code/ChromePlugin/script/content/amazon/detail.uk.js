...
const detailFn = {
  ...
  init() {
    ...
    let descItemNumber = $('#ASIN').val() ? $('#ASIN').val() : $('input:hidden[name=\'asin\']').attr('value') //获取eBay item number文本内容
  ...
  async clickIcon() {
    ...
    if (lang && lang !== 'en_US') {
      ...
      common.setCookie('lc-main', 'en_US', 365, '.amazon.co.uk')
      location.reload()
      return
    } else {
